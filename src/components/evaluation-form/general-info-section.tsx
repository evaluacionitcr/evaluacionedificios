...
export default function GeneralInfoSection({ formData, handleChange }: GeneralInfoSectionProps) {
  return (
    <Card>
      <CardHeader>
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={formData.tipoEvaluacion} onValueChange={(value) => handleChange("tipoEvaluacion", value)}>
